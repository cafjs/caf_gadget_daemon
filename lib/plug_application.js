...
exports.newInstance = function($, spec, cb) {
    try {
        ...
        var extraHostConfig = spec.env.extraHostConfig;
        ...
        var appNameSplit = spec.env.appName.split(json_rpc.NAME_SEPARATOR);
        ...
        var startContainer = function(cb0) {
            ...
            var props = JSON.parse(spec.env.appExtraProps);
